...
function shoppingCart(cartName) {
    this.orderLimit = 50;
    this.deliveryCharge1 = 5;
    this.deliveryCharge2 = 10;
    this.amountBeforeDeliveryCharge2 = 20;
...
shoppingCart.prototype.checkoutStripe = function (parms, clearCart) {
    ...
    StripeCheckout.open({
        ...
        address: false,
        amount: this.getTotalPriceWithDelivery() *100, /** expects an integer **/
        currency: 'usd',
        name: 'Purchase',
...
// Added by Kuri
// get total including delivery charge
shoppingCart.prototype.getDeliveryCharge = function () {
    var total = this.getTotalPrice();
    var delivery = 0;
    if(total <= 0)
        delivery = 0;
    else if(total < this.amountBeforeDeliveryCharge2)
        delivery = this.deliveryCharge1;
    else
        delivery = this.deliveryCharge2;
    return delivery;
};

shoppingCart.prototype.getTotalPriceWithDelivery = function () {
    var total = this.getTotalPrice();
    return total + this.getDeliveryCharge();
}