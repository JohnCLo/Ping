...
User.add({
	...
	phoneNumber: {type: String, initial: true, index: true, width:'medium'},
	stripeCustomerId: {type: String, index:true, width:'medium'},
	credit: {type: Types.Money, index:true, width:'short'}
}, 'Profile', {
...
User.relationship({ ref: 'Order', refPath: 'who', path: 'orders' });
